...
function Rooms() {
  return (
    <div className='min-h-screen w-full p-5'>
      <div className='min-h-[90vh] w-full flex flex-wrap gap-4 lg:gap-0 lg:justify-between justify-center'>
        ...
        {/* Room Card 4 */}
        <div className='h-[70vh] w-full md:w-[48%] lg:w-[23%] bg-[#f7f5f2] shadow-lg hover:shadow-2xl transition-shadow rounded-xl overflow-hidden cursor-pointer'>
          <div className='h-[55vh] w-full bg-[url("/Rooms/Saffron.JPG")] bg-cover bg-center'></div>
          <div className='flex flex-col items-center justify-between p-4'>
