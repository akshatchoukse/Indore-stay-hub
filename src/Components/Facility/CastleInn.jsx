...
function CastleInn() {
  const amenities = [
    ...
    { icon: '🛌', title: 'Deluxe Room', desc: 'Spacious and comfortable deluxe rooms.' },
  ...
  return (
    <div className='p-10 bg-gray-100'>
      <h2 className='text-3xl font-serif font-bold text-center mb-8'>Hotel Castle Inn Facilities</h2>
